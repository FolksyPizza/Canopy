...
public final class PluginMessageUtil {
  ...
  public static PluginMessagePacket rewriteMinecraftBrand(PluginMessagePacket message,
    ...
    // Canopy Session Gateway: present the cluster as "Canopy" in the client's F3 brand line
    // rather than the underlying proxy name.
    String rewrittenBrand = String.format("%s (Canopy)", currentBrand);
