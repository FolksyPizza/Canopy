...
public class ConfigSessionHandler implements MinecraftSessionHandler {
  ...
  public boolean handle(FinishedUpdatePacket packet) {
    ...
    if (canopySeamless()) {
      ...
      // backend's config ourselves and hand the connection to the transition handler, which
      // drives the respawn-based world swap. No reconfiguration screen is shown.
      logger.info("[canopy] backend config finished; transitioning to play (seamless swap)");
